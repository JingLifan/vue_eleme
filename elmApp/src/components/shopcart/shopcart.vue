        ...
        <div class="shopcart">
            <div class="content" @click="toggleList">
                <div class="content-left">
                    ...
                    <div class="desc">共需配送费￥{{delivery_price}}元</div>
                </div>
            ...
            <div class="ball-container">
                <transition-group name="drop" tag="div" v-on:before-enter="beforeEnter" v-on:enter="enter" v-on:after-enter="afterEnter">
                    <div class="ball" v-for="(ball,i) in balls" :key="'my' + i" v-show="ball.show">
            ...
            <transition name="fold">
                <div class="shopList" v-show="listShow">
                    ...
                    <div class="list-content" ref="listContent">
                        <ul>
                            <li class="food" v-for="(food, i) in selectFoods" :key="'fold' + i">
...
export default {
    props: {
        // 父组件goods传给购物车组件的已选中的食品数组，在vue中，如果props的默认值是数组，那么default就要是一个函数
        selectFoods: {
            type: Array,
            default () {
                return [];
            ...
            .content-left
                ...
                .logo-wrapper
                    ...
                    .num
                        ...
                        // box-shadow: h-shadow(必需的。水平阴影的位置。允许负值) v-shadow(必需的。垂直阴影的位置。允许负值) blur(可选。模糊距离) spread(可选。阴影的大小) color inset(可选。从外层的阴影（开始时）改变阴影内侧阴影);
